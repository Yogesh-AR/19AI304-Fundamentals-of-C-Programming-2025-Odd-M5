...
void swapv(int x, int y)
{
    ...
    x = y;
    y = temp;
    printf("After swapping in swapv(): x = %d, y = %d\n", x, y);
}
...
void swapr(int *x, int *y)
{
    ...
    *x = *y;
    *y = temp;
    printf("After swapping in swapr(): a = %d, b = %d\n", *x, *y);
}
...
```
# Output:
<img width="695" height="324" alt="image" src="https://github.com/user-attachments/assets/e5581ae4-7d18-419e-ab1e-2d28019e0ab2" />
...
```
# Output:
<img width="690" height="171" alt="image" src="https://github.com/user-attachments/assets/d64be781-7a86-4de0-a909-199fd3a519b7" />
...
```
# Output:
<img width="763" height="213" alt="image" src="https://github.com/user-attachments/assets/79232ed4-ee46-4eb7-a895-34aa8b14e0bd" />
...
```
# Output:
<img width="679" height="317" alt="image" src="https://github.com/user-attachments/assets/53dfc41a-bad4-4c59-b2fa-53d004df314d" />
...
```
# Output:
<img width="675" height="297" alt="image" src="https://github.com/user-attachments/assets/1a984d11-cb0e-40bb-9614-f7b851f88e9b" />
